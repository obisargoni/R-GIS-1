...
## Install packages required for citations
```{r}
library(citr)
```

Here are some citations: [@ajzenTheoryPlannedBehavior1991][@helbingSelfOrganizingPedestrianMovement2001; @hillierNaturalMovementConfiguration1993]
